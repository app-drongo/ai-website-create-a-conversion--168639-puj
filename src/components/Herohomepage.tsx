        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Savor authentic tagines, exotic spices, and traditional Moroccan dishes crafted with passion in the heart of the city. A culinary journey to Morocco awaits.
            </p>

            {/* Feature list */}
            <ul className="mt-6 grid gap-3 text-sm text-muted-foreground sm:grid-cols-2">
              {[
                "Authentic tagine recipes",
                "Traditional Moroccan spices",
                "Mediterranean dining experience",
                "Cultural cuisine atmosphere",
              ].map((item) => (
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Button size="lg" variant="outline" className="text-base">
                <Play className="mr-2 size-5" /> View Menu
              </Button>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  src="https://images.unsplash.com/photo-1539136788836-5699e78bfc75?q=80&w=1920&auto=format&fit=crop"
                  alt="Authentic Moroccan tagine with aromatic spices"
                  fill
            ...
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">25+</span> years tradition
              </p>
            </div>
          </div>
        </div>
