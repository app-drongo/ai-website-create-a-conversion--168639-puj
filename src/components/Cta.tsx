// Cta Component
// Generated: 2025-08-28T15:32:48.525Z
// Template: cta-c001
// Context: Homepage
...
export default function Cta() {
  const stats = [
    { value: "5000+", label: "Happy Diners", icon: Users },
    { value: "4.9★", label: "Average Rating", icon: Star },
    { value: "25+", label: "Years Experience", icon: Award },
    { value: "7 Days", label: "Open Weekly", icon: Clock }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Indulge in traditional tagines, exotic spices, and Mediterranean flavors that transport you 
                straight to the heart of Marrakech. Reserve your table for an unforgettable culinary journey.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Featured in top culinary publications and food blogs
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Easy Reservations</h3>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Award-Winning Cuisine</h3>
              <p className="text-sm text-muted-foreground">
                Recognized for authentic Moroccan flavors
              </p>
            </div>
